...
const PatientInfo = () => {
    ...
    return (
        ...
        <ul>
            <li style={listItemStyle}>Your data stays anonymous in our system</li>
            <li style={listItemStyle}>We match you with appropriate clinical studies for free!</li>
            <li style={listItemStyle}>Benefit #3</li>
        </ul>
        </div>
    );
}
...
const ResearcherInfo = () => {
    return (
        <div>
            <h1>Information about researchers</h1>
        </div>
    )
}
